...
;	GroupBox("GB1", "Testing", "Control1|Control2, 10, 20", "Green")
;	Gui, Add, Text, Section xMargin, This is Control 3
;	GroupBox("GB2", "Another Test", "This is Control 3", 10, 20, "Blue", 20)
;	Gui, Add, Text, yS, This is Control 4
;	GroupBox("GB3", "Third Test", "Static4", 10, 20, "Red", 20, "Verdana")
...
;	Date: Sept. 5, 2011
;	Additions by: digimystigi & DankRafft
;
;********************************************************************
...
GroupBox(GBvName			;Name for GroupBox control variable
        ...
        ,Colour="Green"     ;Optional colour of the title
		...
		,FixedHeight="")	;Optional fixed height
{
	...
	;Add the GroupBox
	Gui, Add, GroupBox, v%GBvName% x%minX% y%minY% w%GBW% h%GBH% c%Colour%, %Title%
	return
}